...
<div class="relative w-full h-[844px] bg-[#f8f9fa] overflow-hidden flex flex-col" x-data="{ notifEmail: true, notifSchedule: true, notifMessage: true }">
    ...
    <div class="flex-1 overflow-y-auto px-6 pt-6 pb-20">
        ...
        <div class="bg-white rounded-[24px] shadow-sm p-4 flex flex-col transition-shadow duration-300 hover:shadow-md">
            ...
            {{-- Toggle 1 --}}
            <div class="flex items-center justify-between py-4 border-b border-gray-100 px-2 -mx-2 rounded-lg transition-colors duration-300 hover:bg-[#f8f9fa] cursor-pointer" @click="notifEmail = !notifEmail">
                <div>
                ...
                <button :class="notifEmail ? 'bg-[#87B4B8]' : 'bg-gray-200'" 
            ...
            {{-- Toggle 3 --}}
            <div class="flex items-center justify-between py-4 px-2 -mx-2 rounded-lg transition-colors duration-300 hover:bg-[#f8f9fa] cursor-pointer" @click="notifMessage = !notifMessage">
                <div>
                ...
                <button :class="notifMessage ? 'bg-[#87B4B8]' : 'bg-gray-200'" 
                        class="w-12 h-7 rounded-full relative transition-colors duration-300 focus:outline-none shrink-0 shadow-inner">
