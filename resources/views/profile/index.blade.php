...
<div class="relative w-full h-full min-h-[100dvh] md:min-h-0 bg-[#f8f9fa] overflow-hidden flex flex-col" x-data="profileApp()">
    ...
    @if(!$isProfileComplete)
        ...
        <div class="px-6 mt-8 z-10 flex-1 overflow-y-auto pb-[140px]">
            <div class="bg-[#f0f7f8] border border-[#d2e8eb] rounded-2xl p-5 text-center shadow-sm mb-6">
                ...
                <p class="text-[#4b9ba6] text-[13px] leading-relaxed mb-6">
                    Hai {{ explode(' ', Auth::user()->name)[0] }}, kamu belum bisa mengakses seluruh menu profile nih. Yuk lengkapi NIM, Program Studi, dan Nomor WhatsApp kamu dulu!
                </p>
            ...
            {{-- FAQ Button (Accessible even when incomplete) --}}
            <div class="bg-white rounded-2xl shadow-sm p-4 mb-6">
                <a href="{{ route('profile.faq') }}" class="flex items-center justify-between py-2 group hover:bg-gray-50 rounded-lg px-2 transition-all duration-300 transform hover:translate-x-1">
