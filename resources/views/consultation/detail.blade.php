...
<div class="relative w-full h-[844px] bg-[#fafafa] overflow-y-auto px-6 pt-12 pb-8">
    ...
    <div class="flex items-center gap-4 mb-8">
        <a href="{{ route('consultation.index') }}" class="text-[#3d4a5e]">
    ...
    {{-- Main Card --}}
    <div class="bg-white rounded-[24px] border border-gray-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] p-6 w-full">
        
        {{-- User Profile --}}
        <div class="flex items-center gap-6 mb-8">
            {{-- Avatar --}}
            <div class="w-[88px] h-[88px] rounded-full bg-gradient-to-br from-[#f1e5da] to-[#f9f6f2] flex items-center justify-center shrink-0">
        ...
        {{-- Info Box (Grid) --}}
        <div class="border border-gray-200 rounded-[14px] mb-8 overflow-hidden">
            ...
            @if($isOffline)
            {{-- Tempat Konseling --}}
            <div class="border-t border-gray-200 p-4 flex flex-col justify-start">
                <div class="flex items-center gap-2 mb-2.5">
                    {{-- Home Icon --}}
        ...
        @if(!$isOffline)
        {{-- Whatsapp Button --}}
        <a href="{{ $waLink }}" target="_blank" class="w-full border border-gray-200 rounded-[14px] py-3.5 flex items-center justify-center gap-3 hover:bg-gray-50 transition mb-6 mx-auto w-[85%] shadow-sm">
        ...
        {{-- Return Button --}}
        <a href="{{ route('dashboard') }}" class="block w-full bg-[#96b6b9] text-white text-center font-bold text-[14px] py-4 rounded-xl hover:bg-[#85a3a6] transition">
            Kembali ke home
        </a>
