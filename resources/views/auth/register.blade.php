...
<head>
    ...
    <title>Sign Up - FilkomCare</title>
    ...
    <div class="w-full max-w-[430px] min-h-screen bg-white flex flex-col relative">
        ...
        <div class="flex-1 flex flex-col px-7 pt-16">
            ...
            <form action="{{ url('/register') }}" method="POST" class="w-full">
                ...
                <div class="mb-1">
                    <div class="bg-gray-50 rounded-2xl px-5 py-3.5 border border-gray-100">
                        <input type="text" name="nim" value="{{ old('nim') }}" required maxlength="18"
                            placeholder="Input your NIM number" 
                            class="w-full bg-transparent text-slate-dark placeholder-gray-400 text-[13px] focus:outline-none font-normal">
                    </div>
                    <p class="text-[10px] text-gray-300 mt-1.5 ml-1 font-light">NIM harus 18 digit</p>
                </div>
                ...
                <div class="mb-1 mt-3">
                    <div class="bg-gray-50 rounded-2xl px-5 py-3.5 border border-gray-100">
                        <input type="email" name="email" value="{{ old('email') }}" required
                            placeholder="Input your email student" 
                            class="w-full bg-transparent text-slate-dark placeholder-gray-400 text-[13px] focus:outline-none font-normal">
                    </div>
