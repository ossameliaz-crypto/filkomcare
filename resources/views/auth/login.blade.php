...
@section('content')
    ...
    <div class="w-full min-h-screen bg-white flex flex-col relative" id="loginContainer">
        ...
        <div class="flex-1 flex flex-col px-7 pt-16" id="loginContent">
            ...
            <div class="mb-8">
                <h1 class="text-[24px] font-bold text-[#3d4a5e] leading-tight">Login</h1>
                <p class="text-[15px] text-gray-400 mt-1 font-light">Login ke akun FilkomCare</p>
            </div>
                ...
                <div class="mb-4 mt-3">
                    <div class="bg-gray-50 rounded-2xl px-5 py-3.5 border border-gray-100 flex items-center transition-all duration-200 keyboard-input-wrap">
                        <input type="password" name="password" id="passwordInput" required
                            ...
                            data-keyboard="alpha"
                            autocomplete="off">
                        <button type="button" onclick="togglePassword()" class="ml-2 text-gray-400 hover:text-[#3d4a5e] transition focus:outline-none">
        ...
        <div class="w-full text-center pb-10 pt-6">
            <p class="text-[12px] text-gray-400 font-normal">
                ...
                <a href="{{ url('/register') }}" class="text-[#3d4a5e] font-bold hover:text-[#87B4B8] transition-all inline-block hover:scale-105 ml-1">Sign up now</a>
            </p>
        </div>
